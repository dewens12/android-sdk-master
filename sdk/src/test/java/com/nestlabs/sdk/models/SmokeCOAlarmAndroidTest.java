...
public class SmokeCOAlarmAndroidTest {
    ...
    private static final String TEST_SMOKE_ALARM_JSON = "/test-smoke-alarm.json";
    ...
    public void testSmokeCoAlarmToParcel() {
        try {
            ...
            String json = IOUtils.toString(this.getClass().getResourceAsStream(TEST_SMOKE_ALARM_JSON),
                    "utf-8");
